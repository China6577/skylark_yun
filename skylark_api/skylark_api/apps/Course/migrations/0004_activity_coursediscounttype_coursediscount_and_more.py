    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='coursediscount', to='Course.coursediscounttype', verbose_name='优惠类型')),
            ],
            options={
                'verbose_name': '价格优惠策略',
